...
<div id="chart">
<input type="button" class="btn0" value="KOREA" onclick="click_button('ko')">
<input type="button" class="btn1" value="USA"onclick="click_button('us')">
<input type="button" class="btn2" value="JAPAN"onclick="click_button('jp')">
